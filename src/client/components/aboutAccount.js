...
export default class AboutAccount extends React.Component {
  ...
  render () {
    ...
    const preferencesGroup = [
      {
        'name': 'Receive Emails When A Submission Is Rejected',
        'value': 'true',
        'checked': userRow.wantsemails,
        'column': 'wantsemails',
        'modifiable': true,
        'inputType': 'checkbox'
      },
    ...
    const addressGroup = [
      ...
      },
      {
        ...
        'value': userRow.addressstate,
        'column': 'addressstate',
        'modifiable': true,
        'inputType': 'text',
        'minlength': 2,
        'maxlength': 2,
        'title': 'The abbreviation for the state',
        list: 'states'
      },
      {
        'name': 'Zip Code',
        'value': userRow.addresszip,
        'column': 'addresszip',
        'modifiable': true,
        'inputType': 'number',
        'min': 10000,
      ...
      <div id='app'>
        ...
        <div id='mainColumn'>
          ...
          <div id='passwordGroup' className='dataGroup'>
            <button className='showFormButton' data-target='pass' style={{ 'marginBottom': '0.4rem' }}>Change Password
            </button>
