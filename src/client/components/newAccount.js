        ...
        <div id="mainColumn">
          ...
          <form method="POST" action="/newAccount" id="newAccountForm">
            ...
            <div className="formRow">
              <label className="formLabel">
                Name
                <input className="formTextInput" type="text" name="name" maxLength="300"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
                Email
                <input className="formTextInput" type="email" name="email" maxLength="" required></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
                Phone Number
                <input className="formPhoneInput" type="tel" name="phone"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
                Address Line 1
                <input className="formTextInput" type="text" name="address" maxLength="150"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
                Address Line 2
                <input className="formTextInput" type="text" name="address2" maxLength="150"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
                City
                <input className="formTextInput" type="text" name="city" maxLength="75"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
              ...
              <label className="formLabel">
                Zip Code
                <input className="formNumberInput" type="number" name="zip" max="99999"></input>
              </label>
            </div>
            <div className="formRow">
              <label className="formLabel">
            ...
            <div className="formRow">
              <label className="formLabel">
                Confirm Password
                <input className="formPasswordInput" type="password" name="pass2" maxLength="72" required></input>
              </label>
            </div>
            <div className="formRow">
